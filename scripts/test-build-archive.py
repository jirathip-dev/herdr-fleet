...
def checks():
    ...
    with tempfile.TemporaryDirectory(prefix="hf-test-archive-") as tmp:
        ...
        assert schema_facts["state_schema_version"] == 5
        assert schema_facts["migration_chain"][0] == "m0001_initial_state_v1"
        assert schema_facts["migration_chain"][-1] == "m0005_lane_replacements_v5"
        ...
        print("PASS: provenance binds source ref, state schema v5, migration "
              "chain m0001..m0005, and all 17 document schema families")
