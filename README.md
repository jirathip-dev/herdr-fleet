...
herdr-fleet is for one operator managing coding agents across repositories from
...
Herdr runs the agents; herdr-fleet is the companion that observes them and
